...
public abstract class FXMLView {
    ...
    private void init(Class clazz, String conventionalName) {
        ...
        loadAsynchronously(resource, bundle, conventionalName);
    }

    void loadAsynchronously(final URL resource, ResourceBundle bundle, String conventionalName) throws IllegalStateException {
