...
public class ConfiguratorTest {
    ...
    @Test
    public void getSystemPropertiesSupplier() {
        Function<Object, Object> systemPropertiesSupplier = this.cut.getSystemPropertiesSupplier();
        assertNotNull(systemPropertiesSupplier);
        Object apply = systemPropertiesSupplier.apply("java.version");
        assertNotNull(apply);
    }
